        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            <li className="nav-item">
              <Link className="nav-link" to="/shop" style={{ color: 'var(--black)', transition: 'color 0.3s ease'}}>Shop <i className="bi bi-bag"></i></Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/magazine" style={{ color: 'var(--black)', transition: 'color 0.3s ease'}}>
